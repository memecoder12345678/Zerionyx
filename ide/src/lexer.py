    ...
    def __init__(self, editor):
        ...
        self.lib_functions = {
            ...
            "libs.string": [
                ...
                "string.chr",
                "string.is_digit",
                "string.is_ascii_lowercase",
                "string.is_ascii_uppercase",
                "string.is_ascii_letter",
                "string.is_space",
                "string.find",
                "string.find_all",
                "string.startswith",
            ...
            "libs.time": ["time.time", "time.ctime", "time.sleep"],
            "libs.random": [
                "random.rand",
                "random.rand_int",
                "random.rand_choice",
            ...
            "libs.keyboard": [
                ...
                "keyboard.press",
                "keyboard.release",
                "keyboard.keyboard_wait",
                "keyboard.is_pressed",
            ],
            "libs.termcolor": ["termcolor.cprintln", "termcolor.cprint", "termcolor.get_code"],
        }
        self.operators = ["+", "-", "*", "/", "%", "^", "=", "<", ">", "!", "\\", "."]
        self.types = [
            "list",
